...
const BODS_CACHE_SCHEMA_VERSION = "v70-bods-target-corridor-dataset-priority";
const BODS_MAX_DATASETS = 96;
const BODS_MAX_DATASET_QUERY_RESULTS = 96;
const BODS_MAX_DATASET_QUERY_ATTEMPTS = 72;
const BODS_MAX_DATASETS_PER_QUERY = 26;
const BODS_MAX_TOTAL_DOWNLOAD_URLS = 420;
const BODS_ORIGIN_STOP_SEARCH_RADIUS_METRES = 1200;
const BODS_ORIGIN_ROUTE_HINT_RADIUS_METRES = 3500;
const BODS_MAX_ORIGIN_ROUTE_HINTS = 64;
const BODS_MAX_XML_FILES = 420;
const BODS_MAX_CONNECTIONS = 240000;
const BODS_MAX_STOPS = 30000;
...
const BODS_TIMETABLE_ZONE_CLUSTER_LINK_METRES = 7800;
const BODS_TIMETABLE_ZONE_ORIGIN_COMPONENT_LINK_METRES = 7800;
const BODS_TIMETABLE_ZONE_RADIAL_BINS = 192;
const BODS_TIMETABLE_ZONE_SMOOTHING_ITERATIONS = 2;
const BODS_TIMETABLE_ZONE_CONNECTOR_MAX_METRES = 15000;
const BODS_TIMETABLE_ZONE_CONNECTOR_MAX_SPEED_KPH = 65;
const BODS_TIMETABLE_ZONE_CONNECTOR_SAMPLE_SPACING_METRES = 850;
const BODS_TARGET_PLACE_NAMES = ["Horsforth", "Headingley", "Kirkstall", "Pudsey", "Morley", "Cross Gates", "Garforth", "Rothwell", "Armley", "Bramley", "Farsley", "Yeadon", "Otley", "Guiseley", "Hunslet", "Beeston"];
