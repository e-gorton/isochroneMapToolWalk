...
const BODS_HYBRID_ROUTE_EXPANSION_METRES = 10000;
const BODS_HYBRID_ROUTE_STOP_MATCH_METRES = 140;
const BODS_HYBRID_BODS_ANCHOR_MATCH_METRES = 260;
const BODS_HYBRID_ROUTE_REF_MATCH_REQUIRED_WHEN_AVAILABLE = true;
...
async function buildBodsHybridNaptanOsmRouteAccessLinks(timetable, eligiblePhysicalStops, originCoordinates, maximumWalkToBusStopMetres, departureMinutes, maximumBandMinutes, options = {}) {
  ...
  routes.forEach((route, routeIndex) => {
    ...
    route.accessAnchors.forEach((accessAnchor, accessIndex) => {
      const anchorCandidates = buildBodsHybridAnchorCandidatesForAccess(route, accessAnchor, departuresByStopId, departureMinutes, maximumBandMinutes);
